...
function isPalindrome(str) {
  const originStr = str.toLowerCase().replace(/[^a-z0-9]/g, '');
  const reversStr = originStr.split('').reverse().join('');
  return originStr === reversStr;
}
